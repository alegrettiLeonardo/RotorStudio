...
if __name__=="__main__":
    ...
    if "05_08_03" in ("06_03_01","06_03_02","06_03_03","06_05_01","07_09_01"):kw["case"]=a.case
    if "05_08_03"=="06_08_01":kw.update(lhcase=a.lhcase,rhcase=a.rhcase)
    if "05_08_03"=="07_07_01":kw.update(lhcase=a.lhcase,rhcase=a.rhcase,id_case=a.id_case)
    print(run_named("05_08_03",a.outdir,not a.full,**kw))

...
if __name__=="__main__":
    ...
    if "06_03_02" in ("06_03_01","06_03_02","06_03_03","06_05_01","07_09_01"):kw["case"]=a.case
    if "06_03_02"=="06_08_01":kw.update(lhcase=a.lhcase,rhcase=a.rhcase)
    if "06_03_02"=="07_07_01":kw.update(lhcase=a.lhcase,rhcase=a.rhcase,id_case=a.id_case)
    print(run_named("06_03_02",a.outdir,not a.full,**kw))
